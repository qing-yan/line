    ...
    data() {
        return {
            events: [
                ...
                {date: '2025', event: '南京红大爷', address: '', url: '', tag: [''], remark: ''},
                {date: '2025-03-15', event: '央视再批胖猫事件', address: '', url: '', tag: [''], remark: ''},
                {date: '2025', event: '那尔那茜事件', address: '', url: '', tag: [''], remark: ''},
                {date: '2025', event: '亮证姐事件', address: '', url: '', tag: [''], remark: ''},
                {date: '2025', event: '天水幼儿园铅中毒事件', address: '', url: '', tag: [''], remark: ''},
                {date: '2025', event: '释永信', address: '', url: '', tag: [''], remark: ''},
                {date: '2025', event: '武汉大学杨景媛诬告案', address: '', url: '', tag: [''], remark: ''},
                {date: '2025', event: '黄杨甜甜事件', address: '', url: '', tag: [''], remark: ''},
                {date: '2025', event: '旺仔小乔事件', address: '', url: '', tag: [''], remark: ''},
                {date: '2025', event: '大连工业大学开除李欣时事件', address: '', url: '', tag: [''], remark: ''},
                ...
                {date: '2018', address: '泰国', event: '鸿毛药酒谭秦东医生事件', url: 'https://www.bilibili.com/video/BV1oC411J7sW', tag: ['事故', '世界'], remark: ''},
